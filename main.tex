...
\subsection{哈希}
\lstinputlisting[language=c++, firstline=2]{code/str_hash.cpp}
\subsection{KMP 算法}
...
\subsection{杜教筛}
\lstinputlisting[language=c++, firstline=2]{code/du_sieve.cpp}
\subsection{Min 25}
...
\lstinputlisting[language=c++, firstline=2]{code/tri_cycle.cpp}
\subsection{欧拉回路}
\lstinputlisting[language=c++, firstline=2]{code/eular_tour.cpp}
...
\lstinputlisting[language=c++, firstline=2]{code/set_seg.cpp}
\subsection{高精度（二进制压位）}
\lstinputlisting[language=c++, firstline=2]{code/bigint.cpp}
